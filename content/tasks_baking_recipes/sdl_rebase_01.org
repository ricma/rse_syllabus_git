...
apply on top of the commits before, compare to the lines [[output:git_rebase_1][above]] when
[[*Rebasing the Changes from ~vegan~ onto the ~gluten_free~ branch][starting the rebase]].
